...
* **Persistent** **(Sticky Switch only)** - Preserves the value of the sticky switch when turning the radio off, or changing models, and restores the saved value on power on or selecting the model again.&#x20;
